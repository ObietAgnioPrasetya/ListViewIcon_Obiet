package com.example.listviewicon_obiet
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        listBahasa.add(
            Bahasa("Ruby","Ruby is an open source and fully object oriented programing language.",R.drawable.ruby)
        )
        listBahasa.add(
        ...
        listBahasa.add(
            Bahasa("Python","Python is interpreted scripting and object-oriented programming language.",R.drawable.phyton)
        )
        listBahasa.add(
